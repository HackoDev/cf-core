...
from cf_core.api.serializers import (
    DictionarySerializer, ModerationNoteSerializer
)
from cf_core.models import ModerationNote
from cf_core.api.filters import ModerationNotesFilter
...
class DictionaryViewSet(ViewSet):
    # FIXME: use api view instead viewset
...
class ModerationNoteViewSet(mixins.ListModelMixin, GenericViewSet):
    ...
    serializer_class = ModerationNoteSerializer
